...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="p-2 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-slate-700 transition"
    >
      {dark ? (
