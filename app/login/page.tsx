        ...
        <form action={login} className="space-y-4">
          <div className="space-y-1">
            ...
            <input
              ...
              type="email"
              required
              className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-800"
            />
          </div>
